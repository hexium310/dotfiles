...
" syntax match typeParamersStart /\%([_$[:alpha:]]\|{{matchingBraces}}\|{{matchingParenthesis}}\|{{matchingBrackets}}\)/
" syntax match typeParameters /\%(<\_s*{{typeParamersStart}}\([^=<>]\|=[^<]\|<\_s*{{typeParamersStart}}\%([^=<>]\|=[^<]\|<\_s*{{typeParamersStart}}\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)/
" syntax match arrowLookup /\%({{typeParameters}}\?[(]\_s*\%({{inlineComment}}\_s*\)*\%(\%([)]\_s*:\)\|\%(\%(\.\.\.\_s*\)\?{{identifier}}\_s*:\)\)\)\|{{typeparamertStartOfArrow}}\%({{typeParameters}}\?(\_s*\%({{inlineComment}}\_s*\)*\%(\%([_$[:alpha:]]\|{{matchingBraces}}\|{{matchingBrackets}}\|\(\.\.\.\_s*[_$[:alpha:]]\)\)\%([^()]\|{{matchingParenthesis}}\)*\)\?)\%(\_s*:{{possiblyType}}\)\?\_s*=>\)/
" syntax match ArrowFunctionBegin /\%({{startOfIdentifier}}\%(\<async\)\)\?\%([})!\]]\@<!\_s*\%({{arrowLookup}}\)\@=\)/

" syntax match matchingBraces      /\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)/
" syntax match matchingBrackets    /\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)/
" syntax match matchingParenthesis /\%((\%([^()]\|\%(([^()]*)\)\)*)\)/
" syntax match identifier          /[_$[:alpha:]][_$[:alnum:]]*/
" syntax match inlineComment       /\/\*\%([^*]\|\%(\*[^/]\)\)*\*\//
" syntax match possiblyType        /\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+/
" syntax match startOfIdentifier   /[_$[:alnum:]]\@<!\%(\(\.\.\.\)\@<=\|\(\.\)\@<!\)/
" syntax match typeParamersStart   /\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)/
" syntax match typeParameters      /\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)/
" " syntax match typeparamertStartOfArrow //
" syntax match arrowLookup /\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?[(]\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([)]\_s*:\)\|\%(\%(\.\.\.\_s*\)\?[_$[:alpha:]][_$[:alnum:]]*\_s*:\)\)\)\|\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?(\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\|\(\.\.\.\_s*[_$[:alpha:]]\)\)\%([^()]\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\)*\)\?)\%(\_s*:\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+\)\?\_s*=>\)/
" syntax match ArrowFunctionBegin /\%([_$[:alnum:]]\@<!\%(\(\.\.\.\)\@<=\|\(\.\)\@<!\)\%(\<async\)\)\?\%([})!\]]\@<!\_s*\%(\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?[(]\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([)]\_s*:\)\|\%(\%(\.\.\.\_s*\)\?[_$[:alpha:]][_$[:alnum:]]*\_s*:\)\)\)\|\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?(\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\|\(\.\.\.\_s*[_$[:alpha:]]\)\)\%([^()]\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\)*\)\?)\%(\_s*:\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+\)\?\_s*=>\)\)\@=\)/
" syntax match arrowFunctionEnd /\%(=>\|{\|\%(^\_s*\%(export\|function\|class\|interface\|let\|var\|const\|import\|enum\|namespace\|module\|type\|abstract\|declare\)\_s\+\)\)\@=/

" Redefines typescriptArrowFuncDef ----------------------------------------------
syntax clear typescriptArrowFuncDef
syntax match typescriptArrowFuncDef contained        /\%([_$[:alnum:]]\@<!\%(\(\.\.\.\)\@<=\|\%(\.\)\@<!\)\<async\_s\+\)\?[_$[:alpha:]][_$[:alnum:]]*\_s*\%(=>\)\@=/
 \ contains=typescriptArrowFuncArg,typescriptArrowFunc
 \ nextgroup=@typescriptExpression,typescriptBlock
 \ skipwhite skipempty
" syntax region typescriptArrowFuncDef contained start=/(\(\_s*[a-zA-Z$_\[({]\_[^)]*\|\))/ end=/=>/
" syntax match typescriptArrowFuncDef contained /\%((\_s*\%()\_s*:\|\%(\.\.\.\_s*\)\?[_$[:alpha:]][_$[:alnum:]]\_s*:\)\|(\_s*\%(\%(\.\.\.\_s*\)\?\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\)\%([^()]\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\)*\)\?)\%(\_s*:\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+\)\?\_s*=>/
" syntax match typescriptArrowFuncDef contained /\%(\_s*\%(\%()\_s*:\|\%(\.\.\.\_s*\)\?[_$[:alpha:]][_$[:alnum:]]\_s*:\)\|\%(\%(\.\.\.\_s*\)\?\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\)\%([^()]\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\)*\)\?)\%(\_s*:\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+\)\?\_s*=>\)\@=/
syntax region typescriptArrowFuncDef contained start=/\%([_$[:alnum:]]\@<!\%(\(\.\.\.\)\@<=\|\(\.\)\@<!\)\<async\)\?\%([})!\]]\@<!\_s*\%(\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?[(]\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([)]\_s*:\)\|\%(\%(\.\.\.\_s*\)\?[_$[:alpha:]][_$[:alnum:]]*\_s*:\)\)\)\|\%(\%(<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\|<\_s*\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\)\%([^=<>]\|=[^<]\)*>\)*>\)*>\_s*\)\?(\_s*\%(\/\*\%([^*]\|\%(\*[^/]\)\)*\*\/\_s*\)*\%(\%([_$[:alpha:]]\|\%({\%([^{}]\|\%({[^{}]*}\)\)*}\)\|\%(\[\%([^[\]]\|\%(\[[^[\]]*\]\)\)*\]\)\|\(\.\.\.\_s*[_$[:alpha:]]\)\)\%([^()]\|\%((\%([^()]\|\%(([^()]*)\)\)*)\)\)*\)\?)\%(\_s*:\_s*\%([^<>(){}]\|<\%([^<>]\|<[^<>]\+>\)\+>\|([^()]\+)\|{[^{}]\+}\)\+\)\?\_s*=>\)\)\@=\)/ end=/\%(=>\|{\|\%(^\_s*\%(export\|function\|class\|interface\|let\|var\|const\|import\|enum\|namespace\|module\|type\|abstract\|declare\)\_s\+\)\@=\)/

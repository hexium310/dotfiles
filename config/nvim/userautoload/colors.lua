...
set_highlights({
  ...
  { 'DiagnosticHint', { fg = colors.base05, bg = colors.base01 } },
  { 'DiagnosticInfo', { fg = colors.base0C, bg = colors.base01 } },
  ...
  { 'StatusLineDiagnosticInfo', { fg = onedark.black.gui, bg = onedark.cyan.gui } },

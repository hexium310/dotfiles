...
set_highlight('@include', { guifg = colors.base0E })
set_highlight('@keyword.return', { guifg = colors.base08 })
set_highlight('@punctuation.bracket', { guifg = colors.base0D })
set_highlight('@punctuation.special', { guifg = colors.base0C })
set_highlight('@variable', { guifg = colors.base05 })
set_highlight('@variable.builtin', { guifg = colors.base05, gui = 'italic' })
